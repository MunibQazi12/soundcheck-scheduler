                ...
                <div className='md:w-1/2 w-full'>
                    <div className='max-w-lg mx-auto w-full pt-[42px] pb-[78px] px-[14px] flex flex-col justify-center items-center'>
                        ...
                        <div className='sm:mt-11 mt-8 w-full'>
                            <h2 className="lg:text-4xl sm:text-3xl text-2xl leading-1.2 font-bold font-inter text-heading-text">Log into your account</h2>
                        </div>
                        ...
                        <div className='mt-4 w-full'>
                            <a href="void:javascript(0)" className='sm:text-base text-sm text-light-purple '>Forgot password?</a>
                            ...
                            <p className='sm:mt-7 mt-5 sm:text-base text-sm text-heading-text  '>
                                ...
                                <Link href='/signup' className='text-light-purple'>Sign Up</Link></p>
                        </div>
